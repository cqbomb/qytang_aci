...
# ##################################################
class RsLocalEpCP(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.comp.RsLocalEpCP", "cobra.model.fv.EpCP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsLocalEpCP"
    meta.rnFormat = "rslocalEpCP"
    ...
    prop = PropMeta("str", "deployIssues", "deployIssues", 18600, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 18602, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18601, PropCategory.REGULAR)
