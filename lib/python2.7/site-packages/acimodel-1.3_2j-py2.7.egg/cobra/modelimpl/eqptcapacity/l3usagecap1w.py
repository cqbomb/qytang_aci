...
class L3UsageCap1w(Mo):
    ...
    counter = CounterMeta("v6LocalEpCap", CounterCategory.COUNTER, "count", "Local v6 Endpoints capacity")
    counter._propRefs[PropCategory.IMPLICIT_LASTREADING] = "v6LocalEpCapLast"
    counter._propRefs[PropCategory.IMPLICIT_CUMULATIVE] = "v6LocalEpCapCum"
    counter._propRefs[PropCategory.IMPLICIT_PERIODIC] = "v6LocalEpCapPer"
    ...
    counter._propRefs[PropCategory.IMPLICIT_BASELINE] = "v6LocalEpCapBase"
    ...
    counter._propRefs[PropCategory.IMPLICIT_RATE] = "v6LocalEpCapRate"
    meta._counters.append(counter)

    counter = CounterMeta("v4LocalEpCap", CounterCategory.COUNTER, "count", "Local v4 Endpoints capacity")
    counter._propRefs[PropCategory.IMPLICIT_LASTREADING] = "v4LocalEpCapLast"
    counter._propRefs[PropCategory.IMPLICIT_CUMULATIVE] = "v4LocalEpCapCum"
    counter._propRefs[PropCategory.IMPLICIT_PERIODIC] = "v4LocalEpCapPer"
    ...
    counter._propRefs[PropCategory.IMPLICIT_BASELINE] = "v4LocalEpCapBase"
    ...
    counter._propRefs[PropCategory.IMPLICIT_RATE] = "v4LocalEpCapRate"
    meta._counters.append(counter)
    ...
    prop = PropMeta("str", "v4LocalEpCapBase", "v4LocalEpCapBase", 20497, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Local v4 Endpoints capacity baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("v4LocalEpCapBase", prop)

    prop = PropMeta("str", "v4LocalEpCapCum", "v4LocalEpCapCum", 20498, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Local v4 Endpoints capacity cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("v4LocalEpCapCum", prop)
    ...
    prop = PropMeta("str", "v4LocalEpCapPer", "v4LocalEpCapPer", 20499, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Local v4 Endpoints capacity periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("v4LocalEpCapPer", prop)

    prop = PropMeta("str", "v4LocalEpCapRate", "v4LocalEpCapRate", 20507, PropCategory.IMPLICIT_RATE)
    prop.label = "Local v4 Endpoints capacity rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("v4LocalEpCapRate", prop)
    ...
    prop = PropMeta("str", "v6LocalEpCapBase", "v6LocalEpCapBase", 20518, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Local v6 Endpoints capacity baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("v6LocalEpCapBase", prop)

    prop = PropMeta("str", "v6LocalEpCapCum", "v6LocalEpCapCum", 20519, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Local v6 Endpoints capacity cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("v6LocalEpCapCum", prop)
    ...
    prop = PropMeta("str", "v6LocalEpCapPer", "v6LocalEpCapPer", 20520, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Local v6 Endpoints capacity periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("v6LocalEpCapPer", prop)

    prop = PropMeta("str", "v6LocalEpCapRate", "v6LocalEpCapRate", 20528, PropCategory.IMPLICIT_RATE)
    prop.label = "Local v6 Endpoints capacity rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("v6LocalEpCapRate", prop)
