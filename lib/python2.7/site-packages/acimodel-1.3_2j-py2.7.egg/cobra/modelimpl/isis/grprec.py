...
class GrpRec(Mo):
    """
    The database of fabric multicast group elements.

    """

    meta = ClassMeta("cobra.model.isis.GrpRec")

    meta.moClassName = "isisGrpRec"
    meta.rnFormat = "grp-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Group Record"
    ...
    meta.childClasses.add("cobra.model.isis.FtagOifRec")
    meta.childClasses.add("cobra.model.isis.OifListSpine")
    meta.childClasses.add("cobra.model.isis.BdIdRec")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.isis.FtagOifRec", "ftagoif-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.isis.BdIdRec", "bd-"))
    ...
    prop = PropMeta("str", "addr", "addr", 3111, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15787, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "origin", "origin", 3112, PropCategory.REGULAR)
    prop.label = "Origin"
    prop.isOper = True
    prop.defaultValue = 1
