...
class Route(Mo):
    """
    An ISIS route is a managed object that captures the routing information learned through ISIS protocol.

    """

    meta = ClassMeta("cobra.model.isis.Route")

    meta.moClassName = "isisRoute"
    ...
    meta.childClasses.add("cobra.model.isis.RsNhAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.isis.RsNhAtt", "rsnhAtt-"))
    ...
    prop = PropMeta("str", "metric", "metric", 3211, PropCategory.REGULAR)
    prop.label = "Metric"
    prop.isOper = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14491, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pfx", "pfx", 3210, PropCategory.REGULAR)
    prop.label = "Prefix"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "pref", "pref", 3212, PropCategory.REGULAR)
