...
# ##################################################
class GeSnNode(Mo):
    meta = ClassMeta("cobra.model.infra.GeSnNode")

    meta.isAbstract = True
    meta.moClassName = "infraGeSnNode"


    meta.moClassName = "infraGeSnNode"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Generic Controller with Serial Number"
    ...
    prop = PropMeta("str", "name", "name", 22575, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
