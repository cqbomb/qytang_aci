...
# ##################################################
class ARunning(Mo):
    meta = ClassMeta("cobra.model.firmware.ARunning")

    meta.isAbstract = True
    meta.moClassName = "firmwareARunning"
    ...
    meta.concreteSubClasses.add("cobra.model.firmware.ExtChRunning")
    meta.concreteSubClasses.add("cobra.model.firmware.Running")
    meta.concreteSubClasses.add("cobra.model.firmware.CtrlrRunning")
    meta.concreteSubClasses.add("cobra.model.firmware.CardRunning")
    meta.concreteSubClasses.add("cobra.model.firmware.CompRunning")
