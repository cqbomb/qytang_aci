...
# ##################################################
class CtrlrRunning(Mo):
    """
    Information about each controller firmware that is running.

    """

    meta = ClassMeta("cobra.model.firmware.CtrlrRunning")

    meta.moClassName = "firmwareCtrlrRunning"
    meta.rnFormat = "ctrlrrunning"
    ...
    prop = PropMeta("str", "tpmInUse", "tpmInUse", 16622, PropCategory.REGULAR)
    prop.label = "Whether TPM is in use"
    prop.isImplicit = True
    prop.isAdmin = True
