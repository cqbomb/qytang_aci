...
# ##################################################
class ScopedCount(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pol.ScopedCount")

    meta.moClassName = "polScopedCount"
    meta.rnFormat = "scope-[%(scopeDn)s]-%(oCl)s"
    ...
    prop = PropMeta("str", "oCl", "oCl", 20764, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "scopeCl", "scopeCl", 21353, PropCategory.REGULAR)
    prop.label = "Scope"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "scopeDn", "scopeDn", 20761, PropCategory.REGULAR)
    prop.label = "Scope"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, scopeDn, oCl, markDirty=True, **creationProps):
        namingVals = [scopeDn, oCl]
