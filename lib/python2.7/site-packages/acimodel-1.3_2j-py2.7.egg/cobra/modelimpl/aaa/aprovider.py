...
# ##################################################
class AProvider(Mo):
    meta = ClassMeta("cobra.model.aaa.AProvider")

    meta.isAbstract = True
    meta.moClassName = "aaaAProvider"
    ...
    prop = PropMeta("str", "name", "name", 1361, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "timeout", "timeout", 1373, PropCategory.REGULAR)
