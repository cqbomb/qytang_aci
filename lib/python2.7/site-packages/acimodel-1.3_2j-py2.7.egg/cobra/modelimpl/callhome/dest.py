...
class Dest(Mo):
    ...
    meta = ClassMeta("cobra.model.callhome.Dest")

    meta.moClassName = "callhomeDest"
    meta.rnFormat = "dest-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Callhome Destination"
    ...
    prop = PropMeta("str", "adminState", "adminState", 1562, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "email", "email", 1564, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "format", "format", 1567, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "maxSize", "maxSize", 1566, PropCategory.REGULAR)
    prop.label = "Maximum Size"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 5000000)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14176, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 5890, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "urgency", "urgency", 1565, PropCategory.REGULAR)
    prop.label = "Severity Level"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
