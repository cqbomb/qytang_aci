...
class SVPCPath(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.SVPCPath")

    meta.moClassName = "dbgSVPCPath"
    meta.rnFormat = "svpcpath-%(srcNodeId)s-%(srcNodeId2)s-to-%(dstNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Atomic Counter for a Path from a VPC pair to a single node"
    ...
    prop = PropMeta("str", "dstNodeId", "dstNodeId", 16027, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16035, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId", "srcNodeId", 16026, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId2", "srcNodeId2", 16025, PropCategory.REGULAR)
