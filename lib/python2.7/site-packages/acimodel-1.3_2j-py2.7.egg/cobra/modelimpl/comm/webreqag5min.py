...
# ##################################################
class WebReqAg5min(Mo):
    """
    A class that represents the most current aggregated statistics for web requests in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqAg5min", "web requests")
    ...
    meta.moClassName = "commWebReqAg5min"
    meta.rnFormat = "CDcommWebReqAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web requests stats in 5 minute"
