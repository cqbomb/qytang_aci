...
class Ipv6Rec(Mo):
    """
    The IPv6 entries in the COOP endpoint record.

    """

    meta = ClassMeta("cobra.model.coop.Ipv6Rec")

    meta.moClassName = "coopIpv6Rec"
    meta.rnFormat = "epip6-%(addr)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IPv6 Record"
    ...
    prop = PropMeta("str", "addr", "addr", 2495, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
