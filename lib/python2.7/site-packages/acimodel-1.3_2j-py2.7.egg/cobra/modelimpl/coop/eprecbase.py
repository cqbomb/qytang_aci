...
# ##################################################
class EpRecBase(Mo):
    meta = ClassMeta("cobra.model.coop.EpRecBase")

    meta.isAbstract = True
    meta.moClassName = "coopEpRecBase"
