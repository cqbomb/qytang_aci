...
class RtCtx2Leaf(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.coop.RtCtx2Leaf", "cobra.model.coop.CtxRec")

    meta.moClassName = "coopRtCtx2Leaf"
    meta.rnFormat = "rtctx2Leaf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12658, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2590
    prop.defaultValueStr = "coopCtxRec"
    prop._addConstant("coopCtxRec", None, 2590)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12657, PropCategory.REGULAR)
