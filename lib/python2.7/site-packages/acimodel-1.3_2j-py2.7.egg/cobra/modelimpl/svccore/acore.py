...
# ##################################################
class ACore(Mo):
    meta = ClassMeta("cobra.model.svccore.ACore")

    meta.isAbstract = True
    meta.moClassName = "svccoreACore"


    meta.moClassName = "svccoreACore"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Core history"
    ...
    meta.concreteSubClasses.add("cobra.model.svccore.Node")
    meta.concreteSubClasses.add("cobra.model.svccore.Ctrlr")
    ...
    prop = PropMeta("str", "createTime", "createTime", 4735, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "svcName", "svcName", 4738, PropCategory.REGULAR)
