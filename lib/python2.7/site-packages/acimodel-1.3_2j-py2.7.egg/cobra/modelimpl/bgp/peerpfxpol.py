...
class PeerPfxPol(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.PeerPfxPol")

    meta.moClassName = "bgpPeerPfxPol"
    meta.rnFormat = "bgpPfxP-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP Peer Prefix Policy"
    ...
    meta.childClasses.add("cobra.model.bgp.RtPeerPfxPol")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtPeerPfxPol", "rtpeerPfxPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.fv.Tenant")

    meta.superClasses.add("cobra.model.fabric.ProtoPol")
    meta.superClasses.add("cobra.model.bgp.APeerPfxPol")
    ...
    prop = PropMeta("str", "action", "action", 816, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "maxPfx", "maxPfx", 814, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 5884, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "restartTime", "restartTime", 817, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "thresh", "thresh", 815, PropCategory.REGULAR)
