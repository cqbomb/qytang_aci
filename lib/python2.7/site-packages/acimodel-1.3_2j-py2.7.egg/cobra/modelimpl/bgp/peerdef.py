...
class PeerDef(Mo):
    ...
    prop = PropMeta("str", "action", "action", 823, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "maxPfx", "maxPfx", 821, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "restartTime", "restartTime", 824, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "thresh", "thresh", 822, PropCategory.REGULAR)
