...
class IDEpRxBytes1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytes1d", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytes1d"
    meta.rnFormat = "CDopflexIDEpRxBytes1d"
