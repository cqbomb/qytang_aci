...
# ##################################################
class IDEpBcastPktsHist15min(Mo):
    """
    A class that represents historical statistics for broadcast packets in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPktsHist15min", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPktsHist15min"
    meta.rnFormat = "HDopflexIDEpBcastPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical broadcast packets stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpBcastPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 15881, PropCategory.REGULAR)
