...
class EgrBytesHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytesHist15min", "egress bytes")
    ...
    meta.moClassName = "eqptEgrBytesHist15min"
    meta.rnFormat = "HDeqptEgrBytes15min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6195, PropCategory.REGULAR)
