...
# ##################################################
class IngrDropPkts1year(Mo):
    """
    A class that represents the most current statistics for ingress drop packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPkts1year", "ingress drop packets")
    ...
    meta.moClassName = "eqptIngrDropPkts1year"
    meta.rnFormat = "CDeqptIngrDropPkts1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ingress drop packets stats in 1 year"
