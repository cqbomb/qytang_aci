...
class Board(Mo):
    """
    The motherboard of the controller.

    """

    meta = ClassMeta("cobra.model.eqpt.Board")

    meta.moClassName = "eqptBoard"
    meta.rnFormat = "board"
    meta.category = MoCategory.REGULAR
    meta.label = "Board Equipment"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13867, PropCategory.REGULAR)
