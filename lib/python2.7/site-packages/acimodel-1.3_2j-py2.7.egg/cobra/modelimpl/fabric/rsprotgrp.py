...
class RsProtGrp(Mo):
    """
    A source relation to the VPC protection group. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsProtGrp", "cobra.model.fabric.ProtGEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsProtGrp"
    meta.rnFormat = "rsprotGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "deplSt", "deplSt", 11498, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 11497, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11496, PropCategory.REGULAR)
