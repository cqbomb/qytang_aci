...
class RsOoBCons(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.mgmt.RsOoBCons", "cobra.model.vz.OOBBrCP")
    meta.targetNameProps["name"] = "tnVzOOBBrCPName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "mgmtRsOoBCons"
    meta.rnFormat = "rsooBCons-%(tnVzOOBBrCPName)s"
    ...
    prop = PropMeta("str", "deplInfo", "deplInfo", 12536, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14349, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "prio", "prio", 12537, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12535, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVzOOBBrCPName", "tnVzOOBBrCPName", 12534, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "triggerSt", "triggerSt", 12538, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
