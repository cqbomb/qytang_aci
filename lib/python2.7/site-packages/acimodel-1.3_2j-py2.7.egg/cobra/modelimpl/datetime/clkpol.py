...
class ClkPol(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("datetime:ClkPoladminSt_failed_flag", None, 16)
    prop._addConstant("datetime:ClkPolauthSt_failed_flag", None, 32)
    prop._addConstant("datetime:ClkPoldescr_failed_flag", None, 2)
    ...
    prop._addConstant("datetime:ClkPolmonPolDn_failed_flag", None, 1024)
    prop._addConstant("datetime:ClkPolname_failed_flag", None, 1)
    prop._addConstant("datetime:ClkPolownerKey_failed_flag", None, 4)
    prop._addConstant("datetime:ClkPolownerTag_failed_flag", None, 8)
    prop._addConstant("datetime:ClkPolpolDn_failed_flag", None, 32768)
