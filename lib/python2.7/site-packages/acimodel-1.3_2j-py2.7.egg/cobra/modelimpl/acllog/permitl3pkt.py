...
class PermitL3Pkt(Mo):
    ...
    meta.rnFormat = "permitl3pkt-smac-%(srcMacAddr)s-dmac-%(dstMacAddr)s-time-%(timeStamp)s"
    ...
    def __init__(self, parentMoOrDn, srcMacAddr, dstMacAddr, timeStamp, markDirty=True, **creationProps):
        namingVals = [srcMacAddr, dstMacAddr, timeStamp]
