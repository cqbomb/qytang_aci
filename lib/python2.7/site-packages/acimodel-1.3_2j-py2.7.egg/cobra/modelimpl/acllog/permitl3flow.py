...
# ##################################################
class PermitL3Flow(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.acllog.PermitL3Flow")

    meta.moClassName = "acllogPermitL3Flow"
    meta.rnFormat = "permitl3flow-sip-[%(srcIp)s]-dip-[%(dstIp)s]-proto-%(protocol)s-sport-%(srcPort)s-dport-%(dstPort)s-smac-%(srcMacAddr)s-dmac-%(dstMacAddr)s-sintf-%(srcIntf)s-vrfencap-%(vrfEncap)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L3 Flow Permit Record"
    ...
    prop = PropMeta("str", "dstIp", "dstIp", 25087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstMacAddr", "dstMacAddr", 25088, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstPort", "dstPort", 25089, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25151, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "protocol", "protocol", 25090, PropCategory.REGULAR)
    prop.label = "Protocol"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "srcIntf", "srcIntf", 25091, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcIp", "srcIp", 25092, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcMacAddr", "srcMacAddr", 25093, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcPort", "srcPort", 25094, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vrfEncap", "vrfEncap", 25095, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, srcIp, dstIp, protocol, srcPort, dstPort, srcMacAddr, dstMacAddr, srcIntf, vrfEncap, markDirty=True, **creationProps):
        namingVals = [srcIp, dstIp, protocol, srcPort, dstPort, srcMacAddr, dstMacAddr, srcIntf, vrfEncap]
