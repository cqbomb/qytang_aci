...
# ##################################################
class RtAeCtrlrL2InstPol(Mo):
    """
    A target relation to L2 instance policy information. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.l2.RtAeCtrlrL2InstPol", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "l2RtAeCtrlrL2InstPol"
    meta.rnFormat = "rtaeCtrlrL2InstPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13368, PropCategory.REGULAR)
