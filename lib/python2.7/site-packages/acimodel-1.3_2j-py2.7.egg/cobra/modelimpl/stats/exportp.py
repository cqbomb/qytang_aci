...
class ExportP(Mo):
    ...
    meta = ClassMeta("cobra.model.stats.ExportP")

    meta.moClassName = "statsExportP"
    meta.rnFormat = "exp-%(frequency)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Export Policy of an User"
    ...
    meta.childClasses.add("cobra.model.stats.DestP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.stats.DestP", "dest-"))
    ...
    meta.superClasses.add("cobra.model.mon.ExportP")
    ...
    prop = PropMeta("str", "format", "format", 554, PropCategory.REGULAR)
    prop.label = "Data Format"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "frequency", "frequency", 553, PropCategory.REGULAR)
    prop.label = "Export Frequency"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.defaultValue = 0
    prop.defaultValueStr = "stream"
    prop._addConstant("stream", "stream", 0)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13822, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "frequency"))

    # Deployment Meta
    meta.deploymentQuery = True
    meta.deploymentType = "Policy"

    def __init__(self, parentMoOrDn, frequency, markDirty=True, **creationProps):
        namingVals = [frequency]
