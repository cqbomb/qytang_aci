...
class ThrSint64P(Mo):
    ...
    prop._addConstant("eqptcapacityL2UsageLocalEpCapCum", "local-l2-endpoints-capacity-cumulative", 20477)
    ...
    prop._addConstant("eqptcapacityL2UsageLocalEpCapPer", "local-l2-endpoints-capacity-periodic", 20478)
    prop._addConstant("eqptcapacityL2UsageLocalEpCapRate", "local-l2-endpoints-capacity-rate", 20486)
    prop._addConstant("eqptcapacityL2UsageLocalEpCapTr", "local-l2-endpoints-capacity-trend", 20485)
    prop._addConstant("eqptcapacityL2UsageLocalEpCum", "local-l2-endpoints-cumulative", 20001)
    ...
    prop._addConstant("eqptcapacityL2UsageLocalEpPer", "local-l2-endpoints-periodic", 20002)
    prop._addConstant("eqptcapacityL2UsageLocalEpRate", "local-l2-endpoints-rate", 20010)
    ...
    prop._addConstant("eqptcapacityL3UsageCapV4LocalEpCapCum", "local-v4-endpoints-capacity-cumulative", 20498)
    ...
    prop._addConstant("eqptcapacityL3UsageCapV4LocalEpCapPer", "local-v4-endpoints-capacity-periodic", 20499)
    prop._addConstant("eqptcapacityL3UsageCapV4LocalEpCapRate", "local-v4-endpoints-capacity-rate", 20507)
    ...
    prop._addConstant("eqptcapacityL3UsageCapV6LocalEpCapCum", "local-v6-endpoints-capacity-cumulative", 20519)
    ...
    prop._addConstant("eqptcapacityL3UsageCapV6LocalEpCapPer", "local-v6-endpoints-capacity-periodic", 20520)
    prop._addConstant("eqptcapacityL3UsageCapV6LocalEpCapRate", "local-v6-endpoints-capacity-rate", 20528)
    ...
    prop._addConstant("eqptcapacityL3UsageLocalEpCum", "local-l3-endpoints-cumulative", 20022)
    ...
    prop._addConstant("eqptcapacityL3UsageLocalEpPer", "local-l3-endpoints-periodic", 20023)
    prop._addConstant("eqptcapacityL3UsageLocalEpRate", "local-l3-endpoints-rate", 20031)
    ...
    prop._addConstant("eqptcapacityL3UsageV4LocalEpCum", "local-v4-endpoints-cumulative", 20298)
    ...
    prop._addConstant("eqptcapacityL3UsageV4LocalEpPer", "local-v4-endpoints-periodic", 20299)
    prop._addConstant("eqptcapacityL3UsageV4LocalEpRate", "local-v4-endpoints-rate", 20307)
    ...
    prop._addConstant("eqptcapacityL3UsageV6LocalEpCum", "local-v6-endpoints-cumulative", 20319)
    ...
    prop._addConstant("eqptcapacityL3UsageV6LocalEpPer", "local-v6-endpoints-periodic", 20320)
    prop._addConstant("eqptcapacityL3UsageV6LocalEpRate", "local-v6-endpoints-rate", 20328)
