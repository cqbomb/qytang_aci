...
# ##################################################
class UpgJobFault(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.maint.UpgJobFault")

    meta.moClassName = "maintUpgJobFault"
    meta.rnFormat = "upgjobfault"
    meta.category = MoCategory.REGULAR
    meta.label = "Faults associated UpgJob"
    ...
    prop = PropMeta("str", "faultDelegateKey", "faultDelegateKey", 16840, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16841, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "upgradeStatus", "upgradeStatus", 16839, PropCategory.REGULAR)
