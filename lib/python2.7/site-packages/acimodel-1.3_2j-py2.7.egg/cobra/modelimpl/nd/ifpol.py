...
class IfPol(Mo):
    ...
    meta = ClassMeta("cobra.model.nd.IfPol")

    meta.moClassName = "ndIfPol"
    meta.rnFormat = "ndifpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "ND Interface Policy"
    ...
    meta.childClasses.add("cobra.model.nd.RtBDToNdP")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.nd.RtNdIfPol")

    meta.childNamesAndRnPrefix.append(("cobra.model.nd.RtNdIfPol", "rtl3extNdIfPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nd.RtBDToNdP", "rtfvBDToNdP-"))
    ...
    meta.superClasses.add("cobra.model.nd.AIfPol")
    ...
    prop = PropMeta("str", "name", "name", 17809, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
