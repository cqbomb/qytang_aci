...
class RtInfraBD(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtInfraBD", "cobra.model.infra.EPg")

    meta.moClassName = "fvRtInfraBD"
    meta.rnFormat = "rtinfraInfraBD-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "End Point Group"
    meta.writeAccessMask = 0x1001
    meta.readAccessMask = 0x6000000000865601
    ...
    prop = PropMeta("str", "tCl", "tCl", 13132, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4320
    prop.defaultValueStr = "infraEPg"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13131, PropCategory.REGULAR)
