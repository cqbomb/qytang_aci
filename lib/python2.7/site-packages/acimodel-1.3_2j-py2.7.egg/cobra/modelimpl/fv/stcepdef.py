...
class StCEpDef(Mo):
    """
    An internal object that represents a static endpoint.

    """

    meta = ClassMeta("cobra.model.fv.StCEpDef")

    meta.moClassName = "fvStCEpDef"
    meta.rnFormat = "stcepdef-%(mac)s-type-%(type)s"
    ...
    meta.childClasses.add("cobra.model.fv.StIpDef")
    meta.childClasses.add("cobra.model.fv.RsStCEpDefToNode")
    meta.childClasses.add("cobra.model.fv.RsStCEpDefToPathEp")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsStCEpDefToPathEp", "rsstCEpDefToPathEp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsStCEpDefToNode", "rsstCEpDefToNode-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.StIpDef", "ip-"))
    ...
    prop = PropMeta("str", "mac", "mac", 6557, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 15239, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
