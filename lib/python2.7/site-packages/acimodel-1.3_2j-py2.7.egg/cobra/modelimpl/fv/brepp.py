...
class BrEpP(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.BrEpP")

    meta.moClassName = "fvBrEpP"
    meta.rnFormat = "br-[%(epgPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Bridged External EpP"
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.LNodePDef", "lnodep-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.DomDef", "l2dom-"))
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 6530, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14266, PropCategory.REGULAR)
