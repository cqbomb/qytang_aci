...
class ProtEPg(Mo):
    """
    An endpoint group associated with a taboo policy in a given context. This is an internal object.

    """

    meta = ClassMeta("cobra.model.fv.ProtEPg")

    meta.moClassName = "fvProtEPg"
    meta.rnFormat = "prot-[%(epgDn)s]"
    ...
    meta.childClasses.add("cobra.model.fv.RtToEpgProt")
    meta.childClasses.add("cobra.model.fv.RsToTabooDef")
    meta.childClasses.add("cobra.model.fv.RsEPgDefToL2Dom")
    meta.childClasses.add("cobra.model.fv.RsEPgDefToL3Dom")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtToEpgProt", "rtactrlToEpgProt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToTabooDef", "rstoTabooDef-"))
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 6554, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14309, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rtdEpPInfoHolderDn", "rtdEpPInfoHolderDn", 18080, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("rtdEpPInfoHolderDn", prop)
