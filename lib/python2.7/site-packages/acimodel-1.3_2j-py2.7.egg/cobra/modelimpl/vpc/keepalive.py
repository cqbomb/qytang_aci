...
class Keepalive(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("vpc:KeepalivedestIp_failed_flag", None, 4)
    prop._addConstant("vpc:KeepaliveflushTout_failed_flag", None, 16)
    prop._addConstant("vpc:Keepaliveinterval_failed_flag", None, 32)
    ...
    prop._addConstant("vpc:KeepalivemonPolDn_failed_flag", None, 64)
    prop._addConstant("vpc:Keepalivename_failed_flag", None, 1)
    prop._addConstant("vpc:KeepaliveprecType_failed_flag", None, 512)
    prop._addConstant("vpc:KeepaliveprecValue_failed_flag", None, 1024)
    prop._addConstant("vpc:KeepalivesrcIp_failed_flag", None, 131072)
    prop._addConstant("vpc:Keepalivetimeout_failed_flag", None, 262144)
    prop._addConstant("vpc:KeepalivetosByte_failed_flag", None, 524288)
    prop._addConstant("vpc:KeepalivetosCfgType_failed_flag", None, 1048576)
    prop._addConstant("vpc:KeepalivetosType_failed_flag", None, 2097152)
    prop._addConstant("vpc:KeepalivetosValue_failed_flag", None, 4194304)
    prop._addConstant("vpc:KeepaliveudpPort_failed_flag", None, 8388608)
    prop._addConstant("vpc:Keepalivevrf_failed_flag", None, 134217728)
