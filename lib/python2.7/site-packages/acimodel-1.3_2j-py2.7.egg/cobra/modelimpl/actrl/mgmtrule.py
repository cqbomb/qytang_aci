...
class MgmtRule(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("actrl:MgmtRuleaction_failed_flag", None, 4)
    prop._addConstant("actrl:MgmtRuledPcTag_failed_flag", None, 8)
    prop._addConstant("actrl:MgmtRuledescr_failed_flag", None, 2)
    prop._addConstant("actrl:MgmtRuledirection_failed_flag", None, 16)
    prop._addConstant("actrl:MgmtRulefltId_failed_flag", None, 32)
    prop._addConstant("actrl:MgmtRuleid_failed_flag", None, 64)
    prop._addConstant("actrl:MgmtRulelcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("actrl:MgmtRulemarkDscp_failed_flag", None, 128)
    prop._addConstant("actrl:MgmtRulemodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("actrl:MgmtRulemonPolDn_failed_flag", None, 262144)
    prop._addConstant("actrl:MgmtRulename_failed_flag", None, 1)
    prop._addConstant("actrl:MgmtRuleprio_failed_flag", None, 1024)
    prop._addConstant("actrl:MgmtRuleqosGrp_failed_flag", None, 2048)
    prop._addConstant("actrl:MgmtRulesPcTag_failed_flag", None, 4096)
    prop._addConstant("actrl:MgmtRulescopeId_failed_flag", None, 8192)
    prop._addConstant("actrl:MgmtRuletype_failed_flag", None, 16384)
    ...
    prop.isAdmin = True
    prop.range = [(1, 19)]
    prop._addConstant("any_any_any", "any_any_any", 17)
    prop._addConstant("any_any_filter", "any_any_filter", 16)
    prop._addConstant("any_dest_any", "any_dest_any", 15)
    prop._addConstant("any_dest_filter", "any_dest_filter", 13)
    prop._addConstant("any_vrf_any_deny", "any_vrf_any_deny", 18)
    prop._addConstant("black_list", "black_list", 4)
    prop._addConstant("class-eq-allow", "class-eq-allow", 2)
    prop._addConstant("class-eq-deny", "class-eq-deny", 1)
    prop._addConstant("default_action", "default_action", 19)
    prop._addConstant("fabric_infra", "fabric_infra", 5)
    prop._addConstant("fully_qual", "fully_qual", 6)
    prop._addConstant("prov-nonshared-to-cons", "prov-nonshared-to-cons", 3)
    prop._addConstant("shsrc_any_any_deny", "shsrc_any_any_deny", 11)
    prop._addConstant("shsrc_any_any_perm", "shsrc_any_any_perm", 10)
    prop._addConstant("shsrc_any_filt_perm", "shsrc_any_filt_perm", 9)
    prop._addConstant("src_any_any", "src_any_any", 14)
    prop._addConstant("src_any_filter", "src_any_filter", 12)
    prop._addConstant("src_dst_any", "src_dst_any", 8)
    prop._addConstant("system_incomplete", "system_incomplete", 7)
    ...
    prop._addConstant("level3", "level3", 1)
