...
class InfraTarget(Mo):
    ...
    prop._addConstant("compMbrCont", "controller-member-mac/ip-container-(comp.mbrcont)", 7983)
    prop._addConstant("compMbrMac", "controller-member-mac-(comp.mbrmac)", 7984)
    ...
    prop._addConstant("compToEPg", "to-epg-(comp.toepg)", 7980)
    ...
    prop._addConstant("hvsEpCP", "security-group-(hvs.epcp)", 7946)
    prop._addConstant("hvsExtPol", "portgroup-(hvs.extpol)", 105)
    prop._addConstant("hvsFwRule", "firewall-rule-(hvs.fwrule)", 7951)
    prop._addConstant("hvsFwSvc", "firewall-service-(hvs.fwsvc)", 7952)
    prop._addConstant("hvsIpSet", "ip-set-(hvs.ipset)", 7949)
    prop._addConstant("hvsLNode", "distributed-virtual-switch-(hvs.lnode)", 103)
    prop._addConstant("hvsMacSet", "mac-set-(hvs.macset)", 7950)
    prop._addConstant("hvsRFltE", "service-(hvs.rflte)", 7958)
    prop._addConstant("hvsRFltP", "service-group-(hvs.rfltp)", 7955)
    prop._addConstant("hvsResCont", "resource-container-(hvs.rescont)", 6232)
    prop._addConstant("hvsRsRFltAtt", "relation-to-vz-rfltp-(hvs.rsrfltatt)", 7953)
