...
class FabricPol(Mo):
    ...
    meta = ClassMeta("cobra.model.mon.FabricPol")

    meta.moClassName = "monFabricPol"
    meta.rnFormat = "monfab-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Monitoring Policy"
    meta.writeAccessMask = 0x800040000000001
    meta.readAccessMask = 0x8801cef00000001
    ...
    meta.childClasses.add("cobra.model.mon.RtApplMonPol")
    meta.childClasses.add("cobra.model.mon.RtMonInstFabricPol")
    meta.childClasses.add("cobra.model.mon.RtMonIfFabricPol")
    ...
    meta.childClasses.add("cobra.model.mon.RtMonModuleFabricPol")
    meta.childClasses.add("cobra.model.mon.RtResMonFabricPol")
    meta.childClasses.add("cobra.model.mon.FabricTarget")
    meta.childClasses.add("cobra.model.mon.RtMonPolIfPolCons")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtMonModuleFabricPol", "rtfabricMonModuleFabricPol-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtMonInstFabricPol", "rtfabricMonInstFabricPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtMonIfFabricPol", "rtfabricMonIfFabricPol-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtApplMonPol", "rtfabricApplMonPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtResMonFabricPol", "rtresMonFabricPol"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.FabricTarget", "tarfab-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13793, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6940, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
