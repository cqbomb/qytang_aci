...
class FromEPg(Mo):
    """
    The endpoint group that traffic originates from.

    """

    meta = ClassMeta("cobra.model.vz.FromEPg")

    meta.moClassName = "vzFromEPg"
    meta.rnFormat = "fr-[%(epgDefDn)s]"
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.ToEPg", "to-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.LFromEPg", "lFr"))
    ...
    prop = PropMeta("str", "ctxPcTag", "ctxPcTag", 15846, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "epgDefDn", "epgDefDn", 1068, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "isCtxPcTagInUseForRules", "isCtxPcTagInUseForRules", 15847, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "membType", "membType", 15518, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15870, PropCategory.REGULAR)
