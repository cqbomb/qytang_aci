...
class Out(Mo):
    ...
    meta = ClassMeta("cobra.model.l2ext.Out")

    meta.moClassName = "l2extOut"
    meta.rnFormat = "l2out-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L2 Outside"
    meta.writeAccessMask = 0x800001
    meta.readAccessMask = 0x6000000000801701
    ...
    meta.childClasses.add("cobra.model.l2ext.RsEBd")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.l2ext.InstP")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.l2ext.RsL2DomAtt")
    meta.childClasses.add("cobra.model.l2ext.LNodeP")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.RsL2DomAtt", "rsl2DomAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.LNodeP", "lnodep-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.InstP", "instP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.RsEBd", "rseBd"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14197, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6842, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
