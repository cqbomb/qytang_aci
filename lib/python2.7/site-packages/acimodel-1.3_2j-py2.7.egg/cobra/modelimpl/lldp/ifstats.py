...
class IfStats(Mo):
    ...
    meta = ClassMeta("cobra.model.lldp.IfStats")

    meta.moClassName = "lldpIfStats"
    ...
    prop = PropMeta("str", "entriesAged", "entriesAged", 3068, PropCategory.REGULAR)
    prop.label = "Number of Entries Aged"
    prop.isOper = True
    meta.props.add("entriesAged", prop)

    prop = PropMeta("str", "errPktRcvd", "errPktRcvd", 3069, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pktDiscarded", "pktDiscarded", 3070, PropCategory.REGULAR)
    prop.label = "Number of Packets Discarded"
    prop.isOper = True
    meta.props.add("pktDiscarded", prop)

    prop = PropMeta("str", "pktRcvd", "pktRcvd", 3067, PropCategory.REGULAR)
    prop.label = "Number of Packets Received"
    prop.isOper = True
    meta.props.add("pktRcvd", prop)

    prop = PropMeta("str", "pktSent", "pktSent", 3066, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "unrecogTLV", "unrecogTLV", 3071, PropCategory.REGULAR)
