...
class RsEpCPAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsEpCPAtt", "cobra.model.hvs.EpCP")
    ...
    meta.label = "Relation to hvs EpCP"
    ...
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7946
    prop.defaultValueStr = "hvsEpCP"
