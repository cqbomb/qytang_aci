...
class RsRFltAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsRFltAtt", "cobra.model.hvs.RFltP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hvsRsRFltAtt"
    meta.rnFormat = "rsRFltAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to vz RFltP"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23533, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23514, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7955
    prop.defaultValueStr = "hvsRFltP"
    prop._addConstant("hvsRFltP", None, 7955)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23513, PropCategory.REGULAR)
