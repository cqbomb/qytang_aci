...
class EpCPTask(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.EpCPTask")

    meta.moClassName = "hvsEpCPTask"
    meta.rnFormat = "hvsEpCPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23453, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelUsegEpCP", "addordelusegepcp", 2088)
