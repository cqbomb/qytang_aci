...
# ##################################################
class RsRFltAttTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hvs.RsRFltAttTask")

    meta.moClassName = "hvsRsRFltAttTask"
    meta.rnFormat = "hvsRsRFltAttTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23460, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelUsegFwMbr", "addordelusegfwmbr", 2085)
