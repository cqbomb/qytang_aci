...
class FwRuleTask(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.FwRuleTask")

    meta.moClassName = "hvsFwRuleTask"
    meta.rnFormat = "hvsFwRuleTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23454, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelUsegFwRule", "addordelusegfwrule", 2083)
