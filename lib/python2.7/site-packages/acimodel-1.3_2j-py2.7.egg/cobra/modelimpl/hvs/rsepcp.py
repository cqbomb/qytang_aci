...
class RsEpCP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsEpCP", "cobra.model.fv.EpCP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hvsRsEpCP"
    meta.rnFormat = "rsEpCP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to fv EpCP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23510, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23509, PropCategory.REGULAR)
