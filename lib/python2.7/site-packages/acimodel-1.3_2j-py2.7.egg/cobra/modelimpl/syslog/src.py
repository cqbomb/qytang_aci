...
class Src(Mo):
    ...
    meta = ClassMeta("cobra.model.syslog.Src")

    meta.moClassName = "syslogSrc"
    ...
    meta.childClasses.add("cobra.model.syslog.RsDestGroup")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.mon.MonObjDn")

    meta.childNamesAndRnPrefix.append(("cobra.model.syslog.RsDestGroup", "rsdestGroup"))
    ...
    prop = PropMeta("str", "minSev", "minSev", 1581, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14183, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7254, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
