...
class CfgRoot(Mo):
    """
    The root node for the device parameter configuration tree.

    """

    meta = ClassMeta("cobra.model.vns.CfgRoot")

    meta.moClassName = "vnsCfgRoot"
    meta.rnFormat = "cfgRoot-%(cfgType)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Root Node for Configuration Tree."
    ...
    meta.childClasses.add("cobra.model.vns.VBgpDevCfg")
    ...
    meta.childClasses.add("cobra.model.vns.VOspfDevCfg")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.VOspfDevCfg", "ospfDeviceCfg-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.VBgpDevCfg", "bgpDeviceCfg-"))
    ...
    prop = PropMeta("str", "cfgType", "cfgType", 5161, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop.isNaming = True
    prop.defaultValue = 2
    prop.defaultValueStr = "function"
    prop._addConstant("device", "device-config", 0)
    prop._addConstant("function", "function-config", 2)
    prop._addConstant("group", "group-config", 1)
    meta.props.add("cfgType", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14888, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "cfgType"))

    def __init__(self, parentMoOrDn, cfgType, markDirty=True, **creationProps):
        namingVals = [cfgType]
