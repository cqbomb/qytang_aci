...
# ##################################################
class AMItem(Mo):
    meta = ClassMeta("cobra.model.vns.AMItem")

    meta.isAbstract = True
    meta.moClassName = "vnsAMItem"
    ...
    prop = PropMeta("str", "cardinality", "cardinality", 5054, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "key", "key", 5052, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
