...
class LDestination(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("span:LDestinationdescr_failed_flag", None, 2)
    ...
    prop._addConstant("span:LDestinationmonPolDn_failed_flag", None, 32)
    prop._addConstant("span:LDestinationmtu_failed_flag", None, 4)
    prop._addConstant("span:LDestinationname_failed_flag", None, 1)
    prop._addConstant("span:LDestinationport_failed_flag", None, 64)
