...
class RtCtrlrP(Mo):
    """
    A target relation to a vCenter controller in the VMM manager component.

    """

    meta = TargetRelationMeta("cobra.model.vmm.RtCtrlrP", "cobra.model.comp.AEpPD")

    meta.moClassName = "vmmRtCtrlrP"
    meta.rnFormat = "rtcompCtrlrP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11779, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11778, PropCategory.REGULAR)
