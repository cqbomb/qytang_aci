...
class KaP(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("bfd:KaPdetectMult_failed_flag", None, 8)
    prop._addConstant("bfd:KaPechoRxIntvl_failed_flag", None, 16)
    prop._addConstant("bfd:KaPlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("bfd:KaPminRxIntvl_failed_flag", None, 32)
    prop._addConstant("bfd:KaPminTxIntvl_failed_flag", None, 64)
    prop._addConstant("bfd:KaPmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("bfd:KaPmonPolDn_failed_flag", None, 128)
