...
class Nexthop(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("ipv4:Nexthopdescr_failed_flag", None, 2)
    ...
    prop._addConstant("ipv4:NexthopmonPolDn_failed_flag", None, 32768)
    prop._addConstant("ipv4:Nexthopname_failed_flag", None, 1)
    prop._addConstant("ipv4:NexthopnhAddr_failed_flag", None, 32)
    prop._addConstant("ipv4:NexthopnhIf_failed_flag", None, 64)
    prop._addConstant("ipv4:NexthopnhVrf_failed_flag", None, 128)
    prop._addConstant("ipv4:Nexthoppref_failed_flag", None, 1024)
    prop._addConstant("ipv4:NexthoprwEncap_failed_flag", None, 2048)
