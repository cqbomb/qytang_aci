...
class Entry(Mo):
    ...
    meta = ClassMeta("cobra.model.proc.Entry")

    meta.moClassName = "procEntry"
    meta.rnFormat = "proc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Process Entry"
    ...
    prop = PropMeta("str", "descr", "descr", 22599, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "esp", "esp", 4382, PropCategory.REGULAR)
    prop.label = "Stack Pointer"
    prop.isOper = True
    meta.props.add("esp", prop)

    prop = PropMeta("str", "id", "id", 4377, PropCategory.REGULAR)
    prop.label = "Process ID"
    prop.isOper = True
    meta.props.add("id", prop)

    prop = PropMeta("str", "maxMemAlloc", "maxMemAlloc", 4384, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14584, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 4376, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "operSt", "operSt", 4378, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operState", "operState", 4385, PropCategory.REGULAR)
    prop.label = "Operational State"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "pc", "pc", 4380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "stackBase", "stackBase", 4381, PropCategory.REGULAR)
    prop.label = "Stack Base"
    prop.isOper = True
    meta.props.add("stackBase", prop)

    prop = PropMeta("str", "startCnt", "startCnt", 4379, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tty", "tty", 4383, PropCategory.REGULAR)
    prop.label = "TTY"
    prop.isOper = True
    prop.range = [(0, 512)]
