...
class InstAf(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.InstAf")

    meta.moClassName = "bfdInstAf"
    meta.rnFormat = "af-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Instance Address Family"
    ...
    prop = PropMeta("str", "echoSrcAddr", "echoSrcAddr", 22761, PropCategory.REGULAR)
    prop.label = "BFD Source Address for Echo frames"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24880, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "slowIntvl", "slowIntvl", 17066, PropCategory.REGULAR)
    prop.label = "Slow Interval"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "type", "type", 17445, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
