...
# ##################################################
class RsGraphLabel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.planner.RsGraphLabel", "cobra.model.planner.Label")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsGraphLabel"
    meta.rnFormat = "rsgraphLabel"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21340, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21315, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21314, PropCategory.REGULAR)
