...
class MbrCont(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.MbrCont")

    meta.moClassName = "compMbrCont"
    ...
    meta.childClasses.add("cobra.model.comp.MbrMac")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.MbrMac", "mbrmac-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23543, PropCategory.REGULAR)
