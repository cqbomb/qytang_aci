...
class MbrMacTask(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.MbrMacTask")

    meta.moClassName = "compMbrMacTask"
    meta.rnFormat = "compMbrMacTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23450, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateUsegMbrMac", "updateusegmbrmac", 2092)
