...
class RcvdBytesHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytesHist1d", "received bytes")
    ...
    meta.moClassName = "compRcvdBytesHist1d"
    meta.rnFormat = "HDcompRcvdBytes1d-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5924, PropCategory.REGULAR)
