...
class Ctrlr(Mo):
    ...
    meta.childClasses.add("cobra.model.hvs.RFltP")
    ...
    meta.childClasses.add("cobra.model.comp.MbrCont")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.MbrCont", "mbrcont"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.RFltP", "rfltp-"))
    ...
    prop._addConstant("partial-inv", "received-partial-inventory-in-the-last-inventory-sync.-please-verify-the-state-of-hosts-and-vm-in-the-vmm-controller-and-manually-re-trigger-inventory-sync-on-apic", 8192)
