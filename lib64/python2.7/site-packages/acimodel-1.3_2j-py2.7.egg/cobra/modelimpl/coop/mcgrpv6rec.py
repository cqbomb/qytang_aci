...
class McGrpv6Rec(Mo):
    """
    The IPv6 multicast group records.

    """

    meta = ClassMeta("cobra.model.coop.McGrpv6Rec")

    meta.moClassName = "coopMcGrpv6Rec"
    meta.rnFormat = "mgv6-%(version)s-mgv6-%(srcIp)s-mgv6-%(mcGrpIp)s-mgv6-%(vnid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IPv6 Multicast Group Record"
    ...
    prop = PropMeta("str", "mcGrpIp", "mcGrpIp", 2527, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcIp", "srcIp", 2526, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "version", "version", 2525, PropCategory.REGULAR)
    prop.label = "Version"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "vnid", "vnid", 5999, PropCategory.REGULAR)
    prop.label = "VNID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
