...
# ##################################################
class AVRoutingDeviceCfg(Mo):
    meta = ClassMeta("cobra.model.vns.AVRoutingDeviceCfg")

    meta.isAbstract = True
    meta.moClassName = "vnsAVRoutingDeviceCfg"


    meta.moClassName = "vnsAVRoutingDeviceCfg"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Routing Configuration per device context/vrf"
