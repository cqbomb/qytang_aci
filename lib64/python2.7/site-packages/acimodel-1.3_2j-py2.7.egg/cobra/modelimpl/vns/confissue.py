...
class ConfIssue(Mo):
    ...
    prop._addConstant("encap-allocation-conflict-for-virtual-cluster-interface", "encap-is-already-allocated-for-a-virtual-cluster-interface.", 112)
    ...
    prop._addConstant("remote-asn-specified-with-ibgp", "remoe-asn-specified-with-ibgp-configuration", 107)
    ...
    prop._addConstant("static-encap-in-use-by-a-different-bd", "static-encap-is-already-in-use-by-a-different-bd.", 111)
