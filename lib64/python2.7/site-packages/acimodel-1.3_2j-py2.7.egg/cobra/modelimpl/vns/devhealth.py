...
class DevHealth(Mo):
    """
    The health of a service device, typically from 0 (poor) to 100 (good).

    """

    meta = ClassMeta("cobra.model.vns.DevHealth")

    meta.moClassName = "vnsDevHealth"
    meta.rnFormat = "devHealth-[%(priKey)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14887, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "priKey", "priKey", 5160, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
