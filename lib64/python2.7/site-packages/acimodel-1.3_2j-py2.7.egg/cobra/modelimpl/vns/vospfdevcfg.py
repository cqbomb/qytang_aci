...
# ##################################################
class VOspfDevCfg(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.VOspfDevCfg")

    meta.moClassName = "vnsVOspfDevCfg"
    meta.rnFormat = "ospfDeviceCfg-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF Configuration"
    ...
    prop = PropMeta("str", "area", "area", 17831, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("area", prop)

    prop = PropMeta("str", "areaCost", "areaCost", 19886, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "areaCtrl", "areaCtrl", 17966, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "areaType", "areaType", 17965, PropCategory.REGULAR)
    prop.label = "Area Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 19342, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 17870, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
