...
class DevFolder(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.DevFolder")

    meta.moClassName = "vnsDevFolder"
    meta.rnFormat = "devFolder-%(name)s-key-%(key)s"
    ...
    meta.childClasses.add("cobra.model.vns.RsDevFolderToMFolder")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsDevFolderToMFolder", "rsdevFolderToMFolder-"))
    ...
    prop = PropMeta("str", "key", "key", 7329, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14922, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7328, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
