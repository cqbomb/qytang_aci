...
# ##################################################
class VOspfVEncapAsc(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.VOspfVEncapAsc")

    meta.moClassName = "vnsVOspfVEncapAsc"
    meta.rnFormat = "vOspfVEncapAsc"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF Connector Configuration"
    ...
    prop = PropMeta("str", "area", "area", 18283, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("area", prop)

    prop = PropMeta("str", "authKey", "authKey", 18292, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "authKeyId", "authKeyId", 18293, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "authType", "authType", 18291, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cost", "cost", 18289, PropCategory.REGULAR)
    prop.label = "Cost"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 18520, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "deadIntvl", "deadIntvl", 18286, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "helloIntvl", "helloIntvl", 18285, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20442, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nwT", "nwT", 18284, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prio", "prio", 18288, PropCategory.REGULAR)
    prop.label = "Priority"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 255)]
    ...
    prop = PropMeta("str", "rexmitIntvl", "rexmitIntvl", 18287, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "xmitDelay", "xmitDelay", 18290, PropCategory.REGULAR)
