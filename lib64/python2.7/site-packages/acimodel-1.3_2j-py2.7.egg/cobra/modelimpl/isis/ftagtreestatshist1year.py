...
# ##################################################
class FtagTreeStatsHist1year(Mo):
    """
    A class that represents historical statistics for FTAG in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStatsHist1year", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStatsHist1year"
    meta.rnFormat = "HDisisFtagTreeStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6703, PropCategory.REGULAR)
