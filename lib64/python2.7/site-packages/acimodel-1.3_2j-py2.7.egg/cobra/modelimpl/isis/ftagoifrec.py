...
class FtagOifRec(Mo):
    """
    Per-forwarding tag (FTAG) OIF list record.

    """

    meta = ClassMeta("cobra.model.isis.FtagOifRec")

    meta.moClassName = "isisFtagOifRec"
    meta.rnFormat = "ftagoif-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "FTAG OIF Record"
    ...
    prop = PropMeta("str", "id", "id", 3113, PropCategory.REGULAR)
    prop.label = "Ftag ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
