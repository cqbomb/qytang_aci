...
class Nexthop(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("ipv6:NexthopcachedRtCtrl_failed_flag", None, 4)
    prop._addConstant("ipv6:NexthopcontextId_failed_flag", None, 8)
    prop._addConstant("ipv6:Nexthopdescr_failed_flag", None, 2)
    ...
    prop._addConstant("ipv6:NexthopmonPolDn_failed_flag", None, 32768)
    prop._addConstant("ipv6:Nexthopname_failed_flag", None, 1)
    prop._addConstant("ipv6:NexthopnhAddr_failed_flag", None, 32)
    prop._addConstant("ipv6:NexthopnhIf_failed_flag", None, 64)
    prop._addConstant("ipv6:NexthopnhVrf_failed_flag", None, 128)
    prop._addConstant("ipv6:Nexthoppref_failed_flag", None, 1024)
    prop._addConstant("ipv6:NexthoprwEncap_failed_flag", None, 2048)
