...
class Prov(Mo):
    ...
    meta = ClassMeta("cobra.model.l2cap.Prov")

    meta.moClassName = "l2capProv"
    meta.rnFormat = "l2capprov-[%(subj)s]-type-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L2 Capability Provider"
    ...
    prop = PropMeta("str", "subj", "subj", 3555, PropCategory.REGULAR)
    prop.label = "Subject"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 15489, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
