...
class Dot1PClass(Mo):
    ...
    meta = ClassMeta("cobra.model.qos.Dot1PClass")

    meta.moClassName = "qosDot1PClass"
    meta.rnFormat = "dot1P-%(from)s-%(to)s"
    ...
    meta.childClasses.add("cobra.model.qos.RtDefToDot1PClass")

    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RtDefToDot1PClass", "rtDefToDot1PClass"))
    ...
    prop = PropMeta("str", "from", "from", 7084, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "to", "to", 7083, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
