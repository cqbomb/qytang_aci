...
class ERDestination(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("span:ERDestinationdescr_failed_flag", None, 2)
    prop._addConstant("span:ERDestinationdscp_failed_flag", None, 32)
    prop._addConstant("span:ERDestinationdstIp_failed_flag", None, 64)
    prop._addConstant("span:ERDestinationflowId_failed_flag", None, 128)
    ...
    prop._addConstant("span:ERDestinationmonPolDn_failed_flag", None, 256)
    prop._addConstant("span:ERDestinationmtu_failed_flag", None, 4)
    prop._addConstant("span:ERDestinationname_failed_flag", None, 1)
    prop._addConstant("span:ERDestinationsrcIp_failed_flag", None, 8192)
    prop._addConstant("span:ERDestinationttl_failed_flag", None, 16384)
    prop._addConstant("span:ERDestinationtype_failed_flag", None, 32768)
    prop._addConstant("span:ERDestinationverEnforced_failed_flag", None, 131072)
    prop._addConstant("span:ERDestinationver_failed_flag", None, 65536)
    prop._addConstant("span:ERDestinationvnid_failed_flag", None, 262144)
    prop._addConstant("span:ERDestinationvrfName_failed_flag", None, 524288)
