...
# ##################################################
class RsSrcToPathEp(Mo):
    """
    The source access path.

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToPathEp", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "spanRsSrcToPathEp"
    meta.rnFormat = "rssrcToPathEp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Source to Path Endpoint"
    ...
    prop = PropMeta("str", "fstate", "fstate", 17634, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fstateMap", "fstateMap", 17635, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14626, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12984, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12983, PropCategory.REGULAR)
