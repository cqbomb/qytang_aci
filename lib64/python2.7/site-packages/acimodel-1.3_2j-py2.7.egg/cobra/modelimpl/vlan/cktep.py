...
class CktEp(Mo):
    ...
    meta.readAccessMask = 0x220004120101
    ...
    prop = PropMeta("str", "fwdCtrl", "fwdCtrl", 24249, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop._addConstant("proxy-arp", "enable-proxy-arp-on-epg", 8)
    ...
    prop._addConstant("Invalid", "invalid-parameters", 2)
    ...
    prop._addConstant("vlan:CktEpclassPrefOperSt_failed_flag", None, 524288)
    prop._addConstant("vlan:CktEpctrl_failed_flag", None, 8)
    prop._addConstant("vlan:CktEpencap_failed_flag", None, 8192)
    prop._addConstant("vlan:CktEpenfPref_failed_flag", None, 16384)
    prop._addConstant("vlan:CktEpepUpSeqNum_failed_flag", None, 16)
    prop._addConstant("vlan:CktEpepgDn_failed_flag", None, 32768)
    prop._addConstant("vlan:CktEpfabEncap_failed_flag", None, 2097152)
    prop._addConstant("vlan:CktEpfwdCtrl_failed_flag", None, 65536)
    prop._addConstant("vlan:CktEpid_failed_flag", None, 64)
    ...
    prop._addConstant("vlan:CktEpmode_failed_flag", None, 128)
    prop._addConstant("vlan:CktEpmonPolDn_failed_flag", None, 4194304)
    prop._addConstant("vlan:CktEpname_failed_flag", None, 1)
    prop._addConstant("vlan:CktEppcTag_failed_flag", None, 131072)
    prop._addConstant("vlan:CktEpqosPrio_failed_flag", None, 262144)
    prop._addConstant("vlan:CktEptype_failed_flag", None, 512)
