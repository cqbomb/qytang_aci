...
class MstDomPol(Mo):
    ...
    meta = ClassMeta("cobra.model.stp.MstDomPol")

    meta.moClassName = "stpMstDomPol"
    meta.rnFormat = "mstpDomPol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spanning Tree Domain Policy"
    ...
    prop = PropMeta("str", "id", "id", 747, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 4094)]
    ...
    prop = PropMeta("str", "name", "name", 7205, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
