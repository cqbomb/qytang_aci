...
class Class(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("dpp:ClassbeUnit_failed_flag", None, 8)
    prop._addConstant("dpp:Classbe_failed_flag", None, 4)
    prop._addConstant("dpp:ClassburstUnit_failed_flag", None, 32)
    prop._addConstant("dpp:Classburst_failed_flag", None, 16)
    prop._addConstant("dpp:ClassconformAction_failed_flag", None, 64)
    prop._addConstant("dpp:ClassconformMarkCos_failed_flag", None, 128)
    prop._addConstant("dpp:ClassconformMarkDscp_failed_flag", None, 256)
    prop._addConstant("dpp:Classdescr_failed_flag", None, 2)
    prop._addConstant("dpp:ClassexceedAction_failed_flag", None, 512)
    prop._addConstant("dpp:ClassexceedMarkCos_failed_flag", None, 1024)
    prop._addConstant("dpp:ClassexceedMarkDscp_failed_flag", None, 2048)
    ...
    prop._addConstant("dpp:Classmode_failed_flag", None, 4096)
    prop._addConstant("dpp:ClassmonPolDn_failed_flag", None, 2097152)
    prop._addConstant("dpp:Classname_failed_flag", None, 1)
    prop._addConstant("dpp:ClasspirUnit_failed_flag", None, 16384)
    prop._addConstant("dpp:Classpir_failed_flag", None, 8192)
    prop._addConstant("dpp:ClassrateUnit_failed_flag", None, 65536)
    prop._addConstant("dpp:Classrate_failed_flag", None, 32768)
    prop._addConstant("dpp:Classtype_failed_flag", None, 131072)
    prop._addConstant("dpp:ClassviolateAction_failed_flag", None, 262144)
    prop._addConstant("dpp:ClassviolateMarkCos_failed_flag", None, 524288)
    prop._addConstant("dpp:ClassviolateMarkDscp_failed_flag", None, 1048576)
