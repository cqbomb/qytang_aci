...
# ##################################################
class SysCPUHist1w(Mo):
    """
    A class that represents historical statistics for  System cpu in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPUHist1w", "System cpu")
    ...
    meta.moClassName = "procSysCPUHist1w"
    meta.rnFormat = "HDprocSysCPU1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System cpu stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 7061, PropCategory.REGULAR)
