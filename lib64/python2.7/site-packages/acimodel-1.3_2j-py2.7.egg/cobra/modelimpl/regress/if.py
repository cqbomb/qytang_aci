...
class If(Mo):
    ...
    meta = ClassMeta("cobra.model.regress.If")

    meta.moClassName = "regressIf"
    meta.rnFormat = "regr-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Regression Interface"
    ...
    prop = PropMeta("str", "boolProp", "boolProp", 3521, PropCategory.REGULAR)
    prop.label = "Bool Property"
    ...
    prop = PropMeta("str", "enumProp", "enumProp", 3518, PropCategory.REGULAR)
    prop.label = "Enum Property"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "val2"
    prop._addConstant("val1", "val1", 1)
    prop._addConstant("val2", "val2", 2)
    prop._addConstant("val3", "val3", 3)
    meta.props.add("enumProp", prop)

    prop = PropMeta("str", "id", "id", 7115, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "intProp", "intProp", 3520, PropCategory.REGULAR)
    prop.label = "Integer Property"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("intProp", prop)
    ...
    prop = PropMeta("str", "strProp", "strProp", 3519, PropCategory.REGULAR)
    prop.label = "String Property"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("strProp", prop)
