...
class PfxEntry(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("actrl:PfxEntryaddr_failed_flag", None, 32)
    prop._addConstant("actrl:PfxEntrydescr_failed_flag", None, 2)
    prop._addConstant("actrl:PfxEntrylcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("actrl:PfxEntrylocalConsCount_failed_flag", None, 64)
    prop._addConstant("actrl:PfxEntrymodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("actrl:PfxEntrymonPolDn_failed_flag", None, 128)
    prop._addConstant("actrl:PfxEntryname_failed_flag", None, 1)
    prop._addConstant("actrl:PfxEntrypcTag_failed_flag", None, 1024)
    prop._addConstant("actrl:PfxEntrypfxInstrScope_failed_flag", None, 2048)
    prop._addConstant("actrl:PfxEntryremoteConsCount_failed_flag", None, 4096)
    ...
    prop = PropMeta("str", "localConsCount", "localConsCount", 20731, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14412, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "remoteConsCount", "remoteConsCount", 20730, PropCategory.REGULAR)
