...
# ##################################################
class RuleHit15min(Mo):
    """
    A class that represents the most current statistics for rule hits in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHit15min", "rule hits")
    ...
    meta.moClassName = "actrlRuleHit15min"
    meta.rnFormat = "CDactrlRuleHit15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current rule hits stats in 15 minute"
