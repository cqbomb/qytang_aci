...
# ##################################################
class RuleHitHist1w(Mo):
    """
    A class that represents historical statistics for rule hits in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitHist1w", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitHist1w"
    meta.rnFormat = "HDactrlRuleHit1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical rule hits stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 5828, PropCategory.REGULAR)
