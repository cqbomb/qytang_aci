...
class AdjEp(Mo):
    ...
    prop = PropMeta("str", "nativeVlan", "nativeVlan", 2712, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sysObjIdL", "sysObjIdL", 2717, PropCategory.REGULAR)
    prop.label = "System OID Length"
    prop.isOper = True
    meta.props.add("sysObjIdL", prop)

    prop = PropMeta("str", "sysObjIdV", "sysObjIdV", 2716, PropCategory.REGULAR)
