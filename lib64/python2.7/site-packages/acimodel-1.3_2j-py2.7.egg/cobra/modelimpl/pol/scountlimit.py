...
# ##################################################
class SCountLimit(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pol.SCountLimit")

    meta.moClassName = "polSCountLimit"
    meta.rnFormat = "scopesubj-%(scopeCl)s-subj-%(oCl)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Scoped Policy Count"
    ...
    prop = PropMeta("str", "limit", "limit", 21356, PropCategory.REGULAR)
    prop.label = "Limit"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "oCl", "oCl", 21355, PropCategory.REGULAR)
    prop.label = "Scope"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "scopeCl", "scopeCl", 21354, PropCategory.REGULAR)
    prop.label = "Scope"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "scopeCl"))
    meta.namingProps.append(getattr(meta.props, "oCl"))

    def __init__(self, parentMoOrDn, scopeCl, oCl, markDirty=True, **creationProps):
        namingVals = [scopeCl, oCl]
