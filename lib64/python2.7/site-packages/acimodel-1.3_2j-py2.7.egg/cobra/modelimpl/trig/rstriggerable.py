...
# ##################################################
class RsTriggerable(Mo):
    """
    A source relation to the container for a triggerable object.

    """

    meta = SourceRelationMeta("cobra.model.trig.RsTriggerable", "cobra.model.trig.Triggerable")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "trigRsTriggerable"
    meta.rnFormat = "rsTriggerable"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Triggerable Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14227, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12141, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1828
    prop.defaultValueStr = "trigTriggerable"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12140, PropCategory.REGULAR)
