...
class IpRule(Mo):
    """
    The QoS classification rules based on IP values.

    """

    meta = ClassMeta("cobra.model.qosp.IpRule")

    meta.moClassName = "qospIpRule"
    meta.rnFormat = "ip-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IP Classification Rule"
    ...
    prop = PropMeta("str", "addr", "addr", 2180, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "qosmCfgFailedBmp", "qosmCfgFailedBmp", 14978, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("qosp:IpRuleaddr_failed_flag", None, 64)
    prop._addConstant("qosp:IpRuledescr_failed_flag", None, 2)
    prop._addConstant("qosp:IpRulelcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("qosp:IpRulemarkDscp_failed_flag", None, 4)
    prop._addConstant("qosp:IpRulemodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("qosp:IpRulename_failed_flag", None, 1)
    prop._addConstant("qosp:IpRuleqosGrp_failed_flag", None, 32)
    meta.props.add("qosmCfgFailedBmp", prop)

    prop = PropMeta("str", "qosmCfgFailedTs", "qosmCfgFailedTs", 14980, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("qosmCfgFailedTs", prop)

    prop = PropMeta("str", "qosmCfgState", "qosmCfgState", 14979, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
