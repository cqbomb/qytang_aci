...
class Ctx(Mo):
    ...
    meta.readAccessMask = 0x608401002101
    ...
    prop = PropMeta("str", "ctxPKey", "ctxPKey", 20419, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "secLbl", "secLbl", 16232, PropCategory.REGULAR)
