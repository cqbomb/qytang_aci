...
# ##################################################
class ACRulePCommon(Mo):
    meta = ClassMeta("cobra.model.dbg.ACRulePCommon")

    meta.isAbstract = True
    meta.moClassName = "dbgACRulePCommon"


    meta.moClassName = "dbgACRulePCommon"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Atomic Counter Entry Policy Common Fields"
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 4517, PropCategory.REGULAR)
