...
# ##################################################
class RtDomVxlanNsDef(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtDomVxlanNsDef", "cobra.model.infra.ADomP")

    meta.moClassName = "fvnsRtDomVxlanNsDef"
    meta.rnFormat = "rtinfraDomVxlanNsDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16043, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16042, PropCategory.REGULAR)
