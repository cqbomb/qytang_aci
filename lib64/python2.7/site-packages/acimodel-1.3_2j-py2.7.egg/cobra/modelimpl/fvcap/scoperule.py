...
class ScopeRule(Mo):
    ...
    meta = ClassMeta("cobra.model.fvcap.ScopeRule")

    meta.moClassName = "fvcapScopeRule"
    meta.rnFormat = "fvcapsrule-%(subj)s-scope-%(scopeSubj)s-type-%(type)s"
    ...
    prop = PropMeta("str", "faultState", "faultState", 21347, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "scope", "scope", 244, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "scopeSubj", "scopeSubj", 21349, PropCategory.REGULAR)
    prop.label = "Subject"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "subj", "subj", 21348, PropCategory.REGULAR)
    prop.label = "Subject"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 21359, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "scopeSubj"))
    meta.namingProps.append(getattr(meta.props, "type"))

    def __init__(self, parentMoOrDn, subj, scopeSubj, type, markDirty=True, **creationProps):
        namingVals = [subj, scopeSubj, type]
