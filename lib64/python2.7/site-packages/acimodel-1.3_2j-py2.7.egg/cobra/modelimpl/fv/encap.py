...
class Encap(Mo):
    """
    The encapsulation associated with the functions.

    """

    meta = ClassMeta("cobra.model.fv.Encap")

    meta.moClassName = "fvEncap"
    meta.rnFormat = "e-[%(encap)s]"
    ...
    prop = PropMeta("str", "encap", "encap", 1829, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
