...
# ##################################################
class RsStCEpDefToNode(Mo):
    """
    A relation to the abstraction of the path endpoint.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsStCEpDefToNode", "cobra.model.fabric.APathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsStCEpDefToNode"
    meta.rnFormat = "rsstCEpDefToNode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15267, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15266, PropCategory.REGULAR)
