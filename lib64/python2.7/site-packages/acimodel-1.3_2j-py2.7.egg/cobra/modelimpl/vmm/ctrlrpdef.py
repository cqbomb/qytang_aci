...
class CtrlrPDef(Mo):
    """
    A shadow object needed on the iLeaf to get DVS policies for a given controller instance.

    """

    meta = ClassMeta("cobra.model.vmm.CtrlrPDef")

    meta.moClassName = "vmmCtrlrPDef"
    meta.rnFormat = "ctrlrD-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vmm.RsBaseCtrlr")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.vmm.RsBaseCtrlrP")

    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsBaseCtrlrP", "rsbaseCtrlrP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsBaseCtrlr", "rsbaseCtrlr-"))
    ...
    prop = PropMeta("str", "name", "name", 7293, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
