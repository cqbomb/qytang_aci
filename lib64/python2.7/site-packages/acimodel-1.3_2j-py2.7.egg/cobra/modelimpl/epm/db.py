...
class Db(Mo):
    ...
    meta = ClassMeta("cobra.model.epm.Db")

    meta.moClassName = "epmDb"
    ...
    meta.childClasses.add("cobra.model.epm.MacEp")
    meta.childClasses.add("cobra.model.epm.IpEp")

    meta.childNamesAndRnPrefix.append(("cobra.model.epm.MacEp", "mac-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.epm.IpEp", "ip-"))
    ...
    prop = PropMeta("str", "epUpSeqNum", "epUpSeqNum", 20275, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 1977, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ep", "endpoint-database", 1)
