...
class MaxPfxP(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.MaxPfxP")

    meta.moClassName = "bgpMaxPfxP"
    meta.rnFormat = "maxpfxp"
    meta.category = MoCategory.REGULAR
    meta.label = "Maximum Prefix Policy"
    ...
    prop = PropMeta("str", "action", "action", 2639, PropCategory.REGULAR)
    prop.label = "Action"
    ...
    prop = PropMeta("str", "maxPfx", "maxPfx", 2637, PropCategory.REGULAR)
    prop.label = "Maximum Prefixes"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 300000)]
    ...
    prop = PropMeta("str", "restartTime", "restartTime", 2640, PropCategory.REGULAR)
    prop.label = "Restart Time"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    ...
    prop = PropMeta("str", "thresh", "thresh", 2638, PropCategory.REGULAR)
