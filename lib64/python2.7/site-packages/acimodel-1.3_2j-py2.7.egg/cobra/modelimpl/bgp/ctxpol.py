...
class CtxPol(Mo):
    ...
    meta.childClasses.add("cobra.model.bgp.RtEppBgpCtxPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.bgp.RtBgpCtxPol")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtEppBgpCtxPol", "rtfvEppBgpCtxPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtBgpCtxPol", "rtfvBgpCtxPol-"))
    ...
    prop = PropMeta("str", "name", "name", 5873, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
