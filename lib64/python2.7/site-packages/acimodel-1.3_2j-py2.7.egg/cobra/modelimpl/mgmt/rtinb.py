...
class RtInB(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.mgmt.RtInB", "cobra.model.mgmt.InBZone")

    meta.moClassName = "mgmtRtInB"
    meta.rnFormat = "rtinB-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "InB Managed Nodes Zone"
    meta.writeAccessMask = 0x4601
    meta.readAccessMask = 0x6000910000045713
    ...
    prop = PropMeta("str", "tCl", "tCl", 22679, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22678, PropCategory.REGULAR)
