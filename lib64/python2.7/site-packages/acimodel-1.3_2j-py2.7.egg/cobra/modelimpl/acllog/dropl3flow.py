...
class DropL3Flow(Mo):
    ...
    meta.rnFormat = "dropl3flow-sip-[%(srcIp)s]-dip-[%(dstIp)s]-proto-%(protocol)s-sport-%(srcPort)s-dport-%(dstPort)s-smac-%(srcMacAddr)s-dmac-%(dstMacAddr)s-sintf-%(srcIntf)s-vrfencap-%(vrfEncap)s"
