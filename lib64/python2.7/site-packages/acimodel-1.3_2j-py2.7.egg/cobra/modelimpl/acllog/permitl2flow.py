...
# ##################################################
class PermitL2Flow(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.acllog.PermitL2Flow")

    meta.moClassName = "acllogPermitL2Flow"
    meta.rnFormat = "permitl2flow-smac-%(srcMacAddr)s-dmac-%(dstMacAddr)s-sintf-%(srcIntf)s-vlan-%(vlan)s"
    ...
    prop = PropMeta("str", "dstMacAddr", "dstMacAddr", 25081, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25153, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcIntf", "srcIntf", 25082, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcMacAddr", "srcMacAddr", 25083, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vlan", "vlan", 25084, PropCategory.REGULAR)
    prop.label = "VLAN Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, srcMacAddr, dstMacAddr, srcIntf, vlan, markDirty=True, **creationProps):
        namingVals = [srcMacAddr, dstMacAddr, srcIntf, vlan]
