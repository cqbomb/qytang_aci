...
# ##################################################
class RsCommToCtxAtt(Mo):
    """
    A source relation to the SNMP context used to scope the view of the OIDs.

    """

    meta = SourceRelationMeta("cobra.model.snmp.RsCommToCtxAtt", "cobra.model.snmp.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "snmpRsCommToCtxAtt"
    meta.rnFormat = "rsCommToCtxAtt"
    ...
    prop = PropMeta("str", "operSt", "operSt", 15484, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 4
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 15485, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("operStQual", prop)

    prop = PropMeta("str", "parentSKey", "parentSKey", 15312, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 13329, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2532
    prop.defaultValueStr = "snmpCtx"
    prop._addConstant("snmpCtx", None, 2532)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13328, PropCategory.REGULAR)
