...
class PeReplica(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.PeReplica")

    meta.moClassName = "infraPeReplica"
    meta.rnFormat = "peer-%(rplId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Peer Replica"
    ...
    prop = PropMeta("str", "ctrlrId", "ctrlrId", 4924, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 4923, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "rplId", "rplId", 4925, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, rplId, markDirty=True, **creationProps):
        namingVals = [rplId]
