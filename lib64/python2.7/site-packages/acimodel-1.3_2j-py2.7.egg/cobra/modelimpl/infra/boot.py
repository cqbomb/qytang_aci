...
class Boot(Mo):
    """
    The hypervisor boot function provides the policies used for booting hypervisors. For example, the VLAN and endpoint group policies used during hypervisor bootup.

    """

    meta = ClassMeta("cobra.model.infra.Boot")

    meta.moClassName = "infraBoot"
    meta.rnFormat = "boot-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Boot Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14749, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6618, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
