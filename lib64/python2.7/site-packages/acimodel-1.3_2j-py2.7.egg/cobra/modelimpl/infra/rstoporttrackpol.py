...
# ##################################################
class RsToPortTrackPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsToPortTrackPol", "cobra.model.infra.PortTrackPol")
    meta.targetNameProps["name"] = "tnInfraPortTrackPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsToPortTrackPol"
    meta.rnFormat = "rstoPortTrackPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22659, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22657, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7656
    prop.defaultValueStr = "infraPortTrackPol"
    ...
    prop = PropMeta("str", "tnInfraPortTrackPolName", "tnInfraPortTrackPolName", 22656, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnInfraPortTrackPolName", prop)
