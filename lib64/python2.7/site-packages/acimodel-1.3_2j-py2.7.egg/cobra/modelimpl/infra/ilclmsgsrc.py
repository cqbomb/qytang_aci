...
class IlClMsgSrc(Mo):
    ...
    prop._addConstant("expansion_contender_operational_cluster_size_distance_cannot_be_bridged", "expansion-contender-operational-cluster-size-distance-cannot-be-bridged", 12)
    ...
    prop._addConstant("operational_cluster_size_distance_cannot_be_bridged", "operational-cluster-size-distance-cannot-be-bridged", 1)
