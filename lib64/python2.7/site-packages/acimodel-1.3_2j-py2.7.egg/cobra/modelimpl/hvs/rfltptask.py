...
class RFltPTask(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.RFltPTask")

    meta.moClassName = "hvsRFltPTask"
    meta.rnFormat = "hvsRFltPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23459, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelUsegRfltp", "addordelusegrfltp", 2086)
