...
class FwRule(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.FwRule")

    meta.moClassName = "hvsFwRule"
    meta.rnFormat = "fwrule-%(type)s"
    ...
    meta.childClasses.add("cobra.model.hvs.FwSvc")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.FwSvc", "fwsvc"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23531, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 23392, PropCategory.REGULAR)
