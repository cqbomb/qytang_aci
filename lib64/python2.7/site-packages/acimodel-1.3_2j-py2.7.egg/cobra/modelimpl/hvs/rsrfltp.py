...
class RsRFltP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsRFltP", "cobra.model.vz.RFltP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hvsRsRFltP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23518, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23517, PropCategory.REGULAR)
