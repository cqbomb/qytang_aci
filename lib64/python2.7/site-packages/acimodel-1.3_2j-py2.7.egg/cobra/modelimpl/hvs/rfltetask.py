...
class RFltETask(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.RFltETask")

    meta.moClassName = "hvsRFltETask"
    meta.rnFormat = "hvsRFltETask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23458, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelUsegRflte", "addordelusegrflte", 2087)
