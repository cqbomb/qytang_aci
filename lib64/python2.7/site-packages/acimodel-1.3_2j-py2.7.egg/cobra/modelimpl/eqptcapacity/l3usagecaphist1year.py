...
class L3UsageCapHist1year(Mo):
    ...
    prop = PropMeta("str", "v4LocalEpCapCum", "v4LocalEpCapCum", 20508, PropCategory.IMPLICIT_CUMULATIVE)
    ...
    prop = PropMeta("str", "v4LocalEpCapPer", "v4LocalEpCapPer", 20509, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Local v4 Endpoints capacity periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("v4LocalEpCapPer", prop)

    prop = PropMeta("str", "v4LocalEpCapRate", "v4LocalEpCapRate", 20516, PropCategory.IMPLICIT_RATE)
    ...
    prop = PropMeta("str", "v6LocalEpCapCum", "v6LocalEpCapCum", 20529, PropCategory.IMPLICIT_CUMULATIVE)
    ...
    prop = PropMeta("str", "v6LocalEpCapPer", "v6LocalEpCapPer", 20530, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Local v6 Endpoints capacity periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("v6LocalEpCapPer", prop)

    prop = PropMeta("str", "v6LocalEpCapRate", "v6LocalEpCapRate", 20537, PropCategory.IMPLICIT_RATE)
