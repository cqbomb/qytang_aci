...
class Ft(Mo):
    """
    The inventoried fan tray.

    """

    meta = ClassMeta("cobra.model.eqpt.Ft")

    meta.moClassName = "eqptFt"
    meta.rnFormat = "ft"
    ...
    meta.childClasses.add("cobra.model.eqpt.SpromFan")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.SpromFan", "spfan"))
    ...
    prop = PropMeta("str", "fanName", "fanName", 3448, PropCategory.REGULAR)
    prop.label = "Fan Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("fanName", prop)

    prop = PropMeta("str", "fanletFailString", "fanletFailString", 3447, PropCategory.REGULAR)
    prop.label = "Fanlet Failed Qualifier"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("fanletFailString", prop)
    ...
    prop = PropMeta("str", "id", "id", 3445, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14522, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 3446, PropCategory.REGULAR)
