...
class Obfl(Mo):
    """
    The onboard failure log information.

    """

    meta = ClassMeta("cobra.model.eqpt.Obfl")

    meta.moClassName = "eqptObfl"
    meta.rnFormat = "obfl"
    meta.category = MoCategory.REGULAR
    meta.label = "Onboard Failure Log"
    ...
    prop = PropMeta("str", "logT", "logT", 3337, PropCategory.REGULAR)
    prop.label = "Log Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unk"
    prop._addConstant("cntrs", "counters", 1)
    prop._addConstant("cpuhog", "cpu-hog", 3)
    prop._addConstant("envhist", "environmental-history", 4)
    prop._addConstant("errstat", "error-statistics", 5)
    prop._addConstant("instat", "interrupt-statistics", 6)
    prop._addConstant("unk", "unknown", 0)
    meta.props.add("logT", prop)
