...
class RtLcOdDiag(Mo):
    """
    A target relation to a line card. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.eqpt.RtLcOdDiag", "cobra.model.eqptdiagp.LcTsOd")

    meta.moClassName = "eqptRtLcOdDiag"
    meta.rnFormat = "rtlcOdDiag"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12574, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2245
    prop.defaultValueStr = "eqptdiagpLcTsOd"
