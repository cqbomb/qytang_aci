...
class BpSpLic(Mo):
    """
    The backplane SPROM license.

    """

    meta = ClassMeta("cobra.model.eqpt.BpSpLic")

    meta.moClassName = "eqptBpSpLic"
    meta.rnFormat = "bpsplic"
    meta.category = MoCategory.REGULAR
    meta.label = "Backplane Sprom License"
    ...
    prop = PropMeta("str", "uBits", "uBits", 3382, PropCategory.REGULAR)
