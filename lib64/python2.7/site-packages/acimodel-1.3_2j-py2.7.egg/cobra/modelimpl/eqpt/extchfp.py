...
class ExtChFP(Mo):
    """
    An extension chassis port, which is connected to a leaf.

    """

    meta = ClassMeta("cobra.model.eqpt.ExtChFP")

    meta.moClassName = "eqptExtChFP"
    meta.rnFormat = "leafextport-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Extended Chassis Fabric Port"
    ...
    prop = PropMeta("str", "id", "id", 6232, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14510, PropCategory.REGULAR)
