...
class EgrTotalHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrTotalHist15min", "egress")
    ...
    meta.moClassName = "eqptEgrTotalHist15min"
    meta.rnFormat = "HDeqptEgrTotal15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical egress stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 6219, PropCategory.REGULAR)
