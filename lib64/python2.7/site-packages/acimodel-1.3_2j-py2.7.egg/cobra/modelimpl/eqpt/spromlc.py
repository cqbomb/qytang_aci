...
class SpromLc(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.SpromLc")

    meta.moClassName = "eqptSpromLc"
    meta.rnFormat = "splc"
    meta.category = MoCategory.REGULAR
    meta.label = "Linecard Sprom"
    ...
    meta.childClasses.add("cobra.model.eqpt.SpromLcBlk")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.SpromLcBlk", "splcblk"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14520, PropCategory.REGULAR)
